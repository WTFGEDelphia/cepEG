...
import com.example.cepengine.config.disruptor.DataEvent;
...
public class KafkaDataListener {
   ...
   */
  @KafkaListener(topics = "${app.kafka.input-topic}", containerFactory = "defaultKafkaListenerContainerFactory")
